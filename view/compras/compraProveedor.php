    ...
    <div class="col-xs-5" id="scrollToHere">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Realizar Compra</h3>
        ...
        <div id="contrae" class="collapse in">
            ...
            <div class="form-group">
                ...
                <button type="button"  class="btn btn-info btn-md" id="btnRealizarVenta">Realizar Compra</button>
...
<!-- Capa JS  -->
<script src="../js/compras/compraProveedor.js"></script>
<!-- Select2 -->
