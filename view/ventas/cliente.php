    ...
    <div class="col-xs-12" id="scrollToHere">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Registra y actualiza los clientes</h3>
        ...
        <div id="contrae" class="collapse">
            ...
            <form class="form-horizontal">  
                ...
                <div class="form-group">
                  <label for="txtFono" class="col-sm-2 control-label">Fono: </label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="txtFono" placeholder="Fono">
                  </div>
                </div> 
            </form>
            </div>
...
<!-- Capa JS -->
<script src="../js/ventas/cliente.js"></script>
