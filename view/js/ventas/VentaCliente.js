...
function llenarcboCliente(){
	...
	var param_opcion = 'llenarcboCliente';
...
function agregar(){
	...
	if(txtCantidad.value <= objProducto.stock & txtCantidad.value>'0'){
...
function realizarVenta(){
	var param_opcion='insertarVenta';
			...
			success: function(data){
				...
				detalleProducto.forEach(function(e,index){   
					if (e.marca!=null) {
						...
						$.ajax({
							type: 'POST',
							data: 	'param_opcion=' + 'insertarDetalleVenta' +
